    ...
    <>
      ...
      <main className="mx-4 my-16">
        <section className="flex flex-col">
          ...
          <p className="text-base-content/80 mx-5 mt-3 text-center">
          ...
          <img
            ...
            className="mt-8 aspect-[16/9] w-full rounded-lg border-3"
          />
        </section>
        ...
        <section>
          ...
          {[
            ...
            <div className="collapse-arrow bg-base-100 border-base-300 collapse mt-2.5 rounded-lg border">
